...
import torch
import sys
from netdissect import upsample, renormalize, segviz, tally
...
class ImageVisualizer:
    ...
    def pytorch_masked_image(self, imagedata, activations=None, unit=None,
                             level=None, percent_level=None, thickness=0, mask=None,
                             border_color=None, outside_bright=0.25, inside_color=None):
        '''
        Visualizes the given activations, thresholded at a specified level,
